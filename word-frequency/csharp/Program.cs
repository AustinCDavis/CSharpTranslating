...
void Main()
{
    ...
    List<string> sortedKeys = new List<string>(freqCounts.Keys);
    sortedKeys.Sort();

    foreach (string key in sortedKeys.OrderBy(a => a, StringComparer.Ordinal))
    {
        Console.WriteLine(key + ": " + freqCounts[key]);
    }
}
